...
{
    public class ReportProductDataRequest : ServerRequestBase<ReportProductDataRequest.Item>
    {
        public class Item
        {
    ...
    public class ReportDownloadProductDataRequest : ReportDownloadRequestBase<ReportProductDataRequest.Item>
    {
